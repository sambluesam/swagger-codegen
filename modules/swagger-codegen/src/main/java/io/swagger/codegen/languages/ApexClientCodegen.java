...
public class ApexClientCodegen extends DefaultCodegen implements CodegenConfig {
	...
	public ApexClientCodegen() {
		...
		modelTemplateFiles.put("modelMeta.mustache", ".cls-meta.xml");
		apiTemplateFiles.put("api.mustache", ".cls");
		templateDir = "apex";
		apiPackage = "api";
		modelPackage = "model";

		reservedWords = new HashSet<String>(Arrays.asList("abstract", "continue", "for", "new", "switch", "assert",
	...
	public void processOpts() {
		...
		if (additionalProperties.containsKey(CodegenConstants.SERIALIZABLE_MODEL)) {
			this.setSerializableModel(
					Boolean.valueOf((String) additionalProperties.get(CodegenConstants.SERIALIZABLE_MODEL).toString()));
		}

		// need to put back serializableModel (boolean) into
		// additionalProperties as value in additionalProperties is string
	...
	private void sanitizeConfig() {
		...
		// the whole additionalProperties object is injected into the main
		// object passed to the mustache layer
	...
	public Map<String, Object> postProcessModels(Map<String, Object> objs) {
		...
		for (Object _mo : models) {
			...
			for (CodegenProperty var : cm.vars) {
				...
				// put "enumVars" map into `allowableValues", including `name`
				// and `value`
				...
				if (parentModelCodegenPropery.isEnum) {
					...
					while (iterator.hasNext()) {
						...
						if (codegenProperty.isEnum && codegenProperty.equals(parentModelCodegenPropery)) {
							...
							// a duplicate of the one in the parent, so remove
							// it.
							iterator.remove();
						}
					}
